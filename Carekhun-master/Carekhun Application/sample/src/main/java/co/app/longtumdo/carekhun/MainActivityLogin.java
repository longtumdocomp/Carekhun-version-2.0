...
import co.app.longtumdo.carekhun.LineLogin.MainLoginLineActivity;
import fragment.CustomListViewAdapter;
import fragment.RowItem;
...
public class MainActivityLogin extends AppCompatActivity implements AdapterView.OnItemClickListener, TextToSpeech.OnInitListener {
	...
	private static final Class[] CLASSES = new Class[]{
			...
			FirebaseLoginProfileMainActivity.class,
			LoginGoogle.class,
			LoginFacebook.class,
			MainLoginLineActivity.class
	};
			...
			case RESULT_SPEECH: {
				if (resultCode == RESULT_OK && null != data) {
					...
					if(spokenText.equals("อีเมลล์") || spokenText.equals("email")){
						...
						Intent loginEmailAndPassword = new Intent(getApplicationContext(), FirebaseLoginProfileMainActivity.class);
					...
					} else if(spokenText.equals("ไลน์") || spokenText.equals("line")){
						Log.i("spokenText","LoginLine.class");
						Intent loginLine = new Intent(getApplicationContext(), MainLoginLineActivity.class);
						startActivity(loginLine);
					}
				}
				break;
			}
